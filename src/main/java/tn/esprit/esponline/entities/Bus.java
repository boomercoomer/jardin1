...
private static final long serialVersionUID = 1L;
	...
	public Jardin_enfant getKindergarten() {
		return kindergarten;
	}

	public void setKindergarten(Jardin_enfant kindergarten) {
		this.kindergarten = kindergarten;
	}

	public Bus(long matricule, String driver, int seatCapacity, String latStart, String lonStart, String latArrival,
			String lonArrival, double trajet, String rate, double Trajet) {
		super();
		this.matricule = matricule;
		this.Driver = driver;
		this.seatCapacity = seatCapacity;
